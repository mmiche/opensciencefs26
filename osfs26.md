...
Etwas in Erinnerung rufen bzw. prüfen, ob ein Wiedererkennungseffekt
auftritt, kann sehr lehrreich sein. Während man den Inhalt dieser
[Webseite](https://matilda.fss.uu.nl/articles/description-prediction-causation.html)
liest, sollte man sich der beiden html Dateien pValueIssue2 und
CompatibilitySurprisal erinnern, genauer gesagt, deren Kerninhalten
(Stichwort: Abweichungs-P-Wert, anstatt Entscheidungs-P-Wert).
